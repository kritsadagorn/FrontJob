        ...
        <td className="border-b border-r border-stone-200 dark:border-stone-700 py-3 font-light">
          <div className="pl-2 space-y-2 text-sm">
            {Array.from({ length: Math.ceil(row.skills.length / 5) }).map(
              (_, rowIndex) => (
                <div key={rowIndex} className="flex space-x-0 md:space-x-2 flex-wrap">
                  {row.skills
...
const MainTable = ({
  ...
  return (
    ...
    //   </div>
    // </div>
    <table className="w-full bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 border-collapse rounded-lg shadow-s">
